...
BaseLocation = "/data1/kplee/TagProbe/76X";
if Type == "Run2015C":
    Ntuple_Data = BaseLocation + "/v20160208_1st_RunC_BugFix_IsoMu20/TnPTree_v41_76X_RunC.root"
    Ntuple_MC = BaseLocation + "/v20160208_1st_RunC_BugFix_IsoMu20/TnPTree_76X_DYLL_M50_MadGraphMLM_All_WithWeights.root"
elif Type == "Run2015D_All":
    Ntuple_Data = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/TnPTree_v41_76X_RunD_All.root"
    Ntuple_MC = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/TnPTree_76X_DYLL_M50_MadGraphMLM_All_WithWeights.root"
elif Type == "Run2015D_HLTv4p2":
    Ntuple_Data = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/HLTv4p2/TnPTree_v41_76X_RunD_Split_HLTv4p2.root"
    Ntuple_MC = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/HLTv4p2/TnPTree_76X_DYLL_M50_MadGraphMLM_All_WithWeights.root"
elif Type == "Run2015D_HLTv4p3":
    Ntuple_Data = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/HLTv4p3/TnPTree_v41_76X_RunD_Split_HLTv4p3.root"
    Ntuple_MC = BaseLocation + "/v20160208_2nd_RunD_BugFix_IsoMu20/HLTv4p3/TnPTree_76X_DYLL_M50_MadGraphMLM_All_WithWeights.root"
    ...
    for X,B in ALLBINS:
        ...
        if "_from_" in ID:
            ...
            for D in parts[1].split("_and_"):
            	...
            	elif D == "TrkIso_010": DEN.tkIso = cms.vdouble(0, 0.10)
                elif D == "L1SingleMu16": 
        ...
        for N in num.split("_and_"):
            if N == "IsoMu20_OR_IsoTkMu20" or N == "L1SingleMu16":
                numString += [N, "above"]
            else:
                numString += [N, "pass"]
